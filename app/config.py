...
# Centralized command and security limits.
...
SECURITY_ALERT_COOLDOWN = 300.0
AUDIT_LOG_RETENTION = 500
ANTI_SPAM_WINDOW = 8.0
ANTI_SPAM_THRESHOLD = 8
ANTI_RAID_WINDOW = 20.0
...
ACTION_CODE_TTL = 5 * 60
ACTION_CODE_INPUT_TIMEOUT = 60
ACTION_CODE_MAX_ATTEMPTS = 3
